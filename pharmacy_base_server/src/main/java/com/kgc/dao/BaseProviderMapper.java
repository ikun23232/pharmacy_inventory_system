...
public interface BaseProviderMapper extends BaseMapper<BaseProvider> {
    ...
    public List<BaseProvider> getAllProvider();

    List<BaseProvider> getProviderByWareAndMe(@Param("warehouseId") Integer warehouseId, @Param("medecineId") Integer medecineId);
