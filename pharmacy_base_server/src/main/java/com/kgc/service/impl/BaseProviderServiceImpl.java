...
public class BaseProviderServiceImpl extends ServiceImpl<BaseProviderMapper, BaseProvider> implements BaseProviderService {
    ...
    public Message getAllProvider() {
        ...
        return Message.success(allProvider);
    }

    @Override
    public Message getProviderByWareAndMe(Integer warehouseId, Integer medecineId) {
        List<BaseProvider> providerByWareAndMe = baseProviderMapper.getProviderByWareAndMe(warehouseId, medecineId);
        return Message.success(providerByWareAndMe);
    }
}
