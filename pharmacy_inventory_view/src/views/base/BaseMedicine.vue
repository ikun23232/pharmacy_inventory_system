        ...
        <el-form :inline="true">
          ...
          <el-form-item>
            <el-button
              type="primary"
              icon="el-icon-search"
              @click="initMedicineListByPage(1)"
              >查询</el-button
            >
    ...
    >
      ...
      <el-table-column fixed="right" label="操作" width="300">
        <template slot-scope="scope">
          ...
          <el-button
            @click="addProvider(scope.row.id)"
            type="primary"
            size="small"
            >添加供应商</el-button
          >
    ...
    <div class="block">
      ...
      <el-dialog :title="title" :visible.sync="dialogFormVisible">
        ...
        >
          ...
          >
            <el-input
              v-model="baseMedicine.salePrice"
              autocomplete="off"
              placeholder="请输入"
            ></el-input>
          </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button
            type="primary"
            @click="addBaseMedicine"
            v-if="title == '添加医用商品信息'"
            >确 定</el-button
          >
          <el-button
            type="primary"
            @click="updateBaseMedicine"
            v-if="title == '修改医用商品信息'"
            >修 改</el-button
          >
        </div>
