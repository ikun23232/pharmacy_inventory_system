        ...
        <el-col :span="6"
          ><div class="grid-content bg-purple">
            <el-form-item label="需求人" prop="demanderUserName">
              <el-input
                type="text"
                v-model="CgsqOrder.demanderUserName"
                disabled
              ></el-input>
            </el-form-item></div
        ></el-col>
...
export default {
  ...
  methods: {
    ...
    async approveCgsqOrder() {
      if (
        this.CgsqOrder.approvementRemark == "" ||
        this.CgsqOrder.approvementRemark == undefined
      ) {
        Message({
          message: "请输入核批意见!",
          type: "error",
      ...
      let resp = await approveCgsqOrder(
        this.CgsqOrder.id,
        this.CgsqOrder.approvementRemark,
        this.CgsqOrder.approvement
      );
      console.log(resp);
      if (resp.code == "200") {
        Message({
