      ...
      <div id="printView" style="padding-left: 90px; padding-right: 20px">
        ...
        >
          <tr>
            ...
            <td style="padding: 5px" align="left">
              单据日期:{{ saleOrder.dispatchTime }}
            </td>
            <td style="padding: 5px" align="left">
              制单人:{{ saleOrder.documenterName }}
            </td>
            <td style="padding: 5px" align="left">
              单据主题: {{ saleOrder.subject }}
            </td>
          </tr>
          <tr style="margin: 0; padding: 0">
            <td style="padding: 5px" align="left">
              源单号: {{ saleOrder.dispatchCode }}
            </td>
            <td style="padding: 5px" align="left">
              备注: {{ saleOrder.remark }}
            </td>
            <td style="padding: 5px" align="left">
              目标仓库：{{ saleOrder.aimStoreHouseName }}
            </td>
            <td style="padding: 5px" align="left">
              合计金额: {{ saleOrder.price }}元
            </td>
          </tr>
        </table>
