<template>
  <div>
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-input v-model="searchForm.operationIp" placeholder="请输入IP地址" clearable>
        </el-input>
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="operationIp" label="ip账户" width="120">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getNoticeList() {
      ...
      this.$axios
        .post("/user/sysLoginLog/list", this.searchForm)
        .then((res) => {
    ...
    delHandle(id) {
      ...
      this.$axios.post("/user/sysLoginLog/removeBatchByIds", ids).then((res) => {
        this.$message({
          showClose: true,
          message: "恭喜你，操作成功",
          type: "success",
