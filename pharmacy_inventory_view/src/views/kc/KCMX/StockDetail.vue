      ...
      <div style="padding-top: 15px;padding-left: 20px;">
          <el-form :inline="true" >
              ...
              <el-form-item label="仓库">
                  <el-input placeholder="请选择" v-model="object.storehouseName"></el-input>
              </el-form-item>
              <el-form-item label="医用商品名称">
                  <el-input placeholder="请选择" v-model="object.name"></el-input>
              </el-form-item>
              <el-form-item label="医用商品类型">
                  <el-input placeholder="请选择" v-model="object.categoryName"></el-input>
              </el-form-item>
              <el-form-item>
                  <el-button type="primary" icon="el-icon-search" @click="initStockDetailListByPage(1)">查询</el-button>
              ...
              <el-button type="text" icon="el-icon-printer" style="margin-left:18px" @click="printOrder">打印</el-button>
              </el-form-item>
          </el-form>
          </div>
