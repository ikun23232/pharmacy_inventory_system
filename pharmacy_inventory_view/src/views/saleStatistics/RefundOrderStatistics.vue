<template>
    <div id="refundOrderStatistics">
     ...
     <el-table :stripe=true :data="list" border fit style="width:100%;text-align: center;">
       ...
       <el-table-column prop="totalAmount" label="退款金额" >
       </el-table-column>
     </el-table>
     <div class="block">
       <p>
 ...
 export default {
     ...
     mounted() {
       this.initRefundOrderStatisticsList(1);
     },
     methods:{
         async initRefundOrderStatisticsList(currentPage) {
             this.object.currentPage=currentPage;
             let data = await getRefundOrderStatisticsList(this.object);
